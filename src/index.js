  ...
  return new HTMLRewriter()
    .on('head', {
      element(el) {
        ...
        el.append('<link rel="stylesheet" href="/assets/final-polish.css?v=1">', { html: true });
        el.append('<script src="/assets/app.js?v=6" defer></script>', { html: true });
      }
    })
    .on('nav', {
      element(el) {
