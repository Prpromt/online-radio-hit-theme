...
.orh-levels-terms{padding:76px 5vw;background:#fff}.orh-levels-terms-inner{max-width:850px}.orh-levels-terms h2{font-size:42px;letter-spacing:-.055em;margin:0 0 20px}.orh-levels-terms p{color:var(--lp-muted);font-size:13px;line-height:1.75}.orh-levels-terms strong{color:#111216}.orh-levels-cta{margin-top:30px;display:inline-block;background:var(--lp-acid);border:1px solid #cddd00;border-radius:12px;padding:14px 19px;text-decoration:none;color:#111216;font-size:11px;font-weight:900;transition:transform .18s ease,box-shadow .18s ease}.orh-levels-cta:hover{transform:translateY(-2px);box-shadow:0 10px 25px rgba(25,28,35,.1)}
@media(max-width:1100px){.orh-levels-grid{grid-template-columns:1fr}.orh-level-card{min-height:0}.orh-level-card.featured{transform:none}.orh-levels-intro{display:block}.orh-levels-intro p{margin-top:20px}.orh-levels-wrap,.orh-levels-how,.orh-levels-terms{padding-left:25px;padding-right:25px}}
@media(max-width:600px){.orh-levels-hero{padding:58px 22px 58px}.orh-levels-hero h1{font-size:clamp(45px,14vw,68px);line-height:.92}.orh-levels-lead{font-size:16px}.orh-levels-wrap{padding-top:58px;padding-bottom:58px}.orh-levels-intro h2{font-size:39px}.orh-level-card{padding:24px;border-radius:20px}.orh-level-card h3{font-size:29px}.orh-levels-how{padding-top:60px;padding-bottom:60px}.orh-levels-how h2{font-size:40px}.orh-how-item{padding:21px}.orh-levels-terms{padding-top:58px;padding-bottom:58px}.orh-levels-terms h2{font-size:35px}}
</style>
